...
class VelocityAndDirectionServiceTest {
    ...
    private VelocityAndDirectionData sumTest;
    ...
    void setUp() {
        ...
        sumTest = new VelocityAndDirectionData(
                null,
                94780 * 2,
                420 * 2,
                720 * 2,
    ...
    void sumsTest() {
    	...
    	var sumTestDataset = VelocityAndDirectionService.datasetSums(lines);
    	assertEquals(sumTest, sumTestDataset);
    }
}